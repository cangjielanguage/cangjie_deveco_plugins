...
/**
 * preview generate cangjie resource
 *
 * @since 2024/1/6
 */
export class PreviewGenerateCangjieResource extends AbstractGenerateCangjieResource {
  constructor(taskService: TargetTaskService) {
    super(taskService, CangjieTaskNames.PREVIEW_GENERATE_CJ_RESOURCE);
  }

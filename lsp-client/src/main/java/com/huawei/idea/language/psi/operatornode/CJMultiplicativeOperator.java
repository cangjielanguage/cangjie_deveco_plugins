...
package com.huawei.idea.language.psi.operatornode;
...
/**
 * CJMultiplicativeOperator
 *
 * @since 2025/12/16
 */
public class CJMultiplicativeOperator extends CJPsiNode implements CangjieGetID {
    public CJMultiplicativeOperator(@NotNull ASTNode node) {
        super(node);
    }

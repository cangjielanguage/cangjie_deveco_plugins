...
import com.huawei.ideacj.language.psi.compileunitnode.CjPreamble;
import com.huawei.ideacj.language.psi.compileunitnode.CjTranslationUnit;
import com.huawei.ideacj.language.psi.importnode.CjImportAlias;
import com.huawei.ideacj.language.psi.importnode.CjImportAll;
import com.huawei.ideacj.language.psi.importnode.CjImportAllAlias;
...
import com.huawei.ideacj.language.psi.operatornode.CJAdditiveOperator;
import com.huawei.ideacj.language.psi.operatornode.CJAssignmentOperator;
import com.huawei.ideacj.language.psi.operatornode.CJComparisonOperator;
import com.huawei.ideacj.language.psi.operatornode.CJConditionOperator;
import com.huawei.ideacj.language.psi.operatornode.CJEqualityOperator;
import com.huawei.ideacj.language.psi.operatornode.CJFlowOperator;
import com.huawei.ideacj.language.psi.operatornode.CJShiftingOperator;
import com.huawei.ideacj.language.psi.operatornode.CJMultiplicativeOperator;
import com.huawei.ideacj.language.psi.othersnode.CjAdCallSuffix;
import com.huawei.ideacj.language.psi.othersnode.CjArrowParameters;
import com.huawei.ideacj.language.psi.othersnode.CjAtomicExpression;
import com.huawei.ideacj.language.psi.othersnode.CjCallSuffix;
import com.huawei.ideacj.language.psi.othersnode.CjCharContent;
import com.huawei.ideacj.language.psi.othersnode.CjCollectionLiteral;
import com.huawei.ideacj.language.psi.othersnode.CjConstTypeParameter;
import com.huawei.ideacj.language.psi.othersnode.CjDiffFunc;
import com.huawei.ideacj.language.psi.othersnode.CjEnd;
import com.huawei.ideacj.language.psi.othersnode.CjEnumPattern;
import com.huawei.ideacj.language.psi.othersnode.CjExceptionTypePattern;
import com.huawei.ideacj.language.psi.othersnode.CjFieldAccess;
import com.huawei.ideacj.language.psi.othersnode.CjIdentifier;
import com.huawei.ideacj.language.psi.othersnode.CjIndexAccess;
import com.huawei.ideacj.language.psi.othersnode.CjItemAfterQuest;
import com.huawei.ideacj.language.psi.othersnode.CjLambdaExpression;
import com.huawei.ideacj.language.psi.othersnode.CjLambdaParameter;
import com.huawei.ideacj.language.psi.othersnode.CjLeftAuxExpression;
import com.huawei.ideacj.language.psi.othersnode.CjLeftValueExpression;
import com.huawei.ideacj.language.psi.othersnode.CjLineStringContent;
import com.huawei.ideacj.language.psi.othersnode.CjLineStringLiteral;
import com.huawei.ideacj.language.psi.othersnode.CjLiteralConstant;
...
import com.huawei.ideacj.language.psi.othersnode.CjQuoteToken;
import com.huawei.ideacj.language.psi.othersnode.CjResourceSpecification;
import com.huawei.ideacj.language.psi.othersnode.CjStringLiteral;
import com.huawei.ideacj.language.psi.othersnode.CjSynchronizedExpression;
import com.huawei.ideacj.language.psi.othersnode.CjTupleType;
import com.huawei.ideacj.language.psi.othersnode.CjTypePattern;
import com.huawei.ideacj.language.psi.othersnode.CjValueArgument;
import com.huawei.ideacj.language.psi.othersnode.CjVarBindingPattern;
import com.huawei.ideacj.language.psi.othersnode.CjAnnotation;
...
import com.huawei.ideacj.language.psi.toplevel.CjDefaultParameter;
import com.huawei.ideacj.language.psi.toplevel.CjGenericConstraints;
import com.huawei.ideacj.language.psi.toplevel.CjNamedParameter;
import com.huawei.ideacj.language.psi.toplevel.CjNamedParameterList;
...
import com.huawei.ideacj.language.psi.toplevel.CjTypeParameters;
import com.huawei.ideacj.language.psi.toplevel.CjUnnamedParameter;
import com.huawei.ideacj.language.psi.toplevel.CjUnnamedParameterList;
import com.huawei.ideacj.language.psi.toplevel.classnode.CjAssociatedTypeDeclaration;
import com.huawei.ideacj.language.psi.toplevel.classnode.CjAssociatedTypeDefinition;
...
import com.huawei.ideacj.language.psi.toplevel.classnode.CjClassMemberDeclaration;
import com.huawei.ideacj.language.psi.toplevel.classnode.CjClassModifierList;
import com.huawei.ideacj.language.psi.toplevel.classnode.CjClassName;
import com.huawei.ideacj.language.psi.toplevel.classnode.CjClassNamedInitParam;
import com.huawei.ideacj.language.psi.toplevel.classnode.CjClassNamedInitParamList;
import com.huawei.ideacj.language.psi.toplevel.classnode.CjClassPrimaryInit;
import com.huawei.ideacj.language.psi.toplevel.classnode.CjClassPrimaryInitParamLists;
import com.huawei.ideacj.language.psi.toplevel.classnode.CjClassType;
import com.huawei.ideacj.language.psi.toplevel.classnode.CjClassUnnamedInitParam;
import com.huawei.ideacj.language.psi.toplevel.classnode.CjClassUnnamedInitParamList;
import com.huawei.ideacj.language.psi.toplevel.classnode.CjForeignBody;
import com.huawei.ideacj.language.psi.toplevel.classnode.CjForeignMemberDeclaration;
import com.huawei.ideacj.language.psi.toplevel.classnode.CjInterfaceType;
import com.huawei.ideacj.language.psi.toplevel.classnode.CjMatchExpression;
import com.huawei.ideacj.language.psi.toplevel.classnode.CjPropertyBody;
import com.huawei.ideacj.language.psi.toplevel.classnode.CjPropertyDefinition;
import com.huawei.ideacj.language.psi.toplevel.classnode.CjPropertyMemberDeclaration;
import com.huawei.ideacj.language.psi.toplevel.classnode.CjPropertyMemberVar;
import com.huawei.ideacj.language.psi.toplevel.classnode.CjSuperClass;
import com.huawei.ideacj.language.psi.toplevel.classnode.CjSuperClassOrInterfaces;
import com.huawei.ideacj.language.psi.toplevel.classnode.CjSuperInterfaces;
import com.huawei.ideacj.language.psi.toplevel.classnode.CjUpperBounds;
import com.huawei.ideacj.language.psi.toplevel.classnode.CjUserType;
import com.huawei.ideacj.language.psi.toplevel.classnode.CjClassFinalizer;
...
import com.huawei.ideacj.language.psi.toplevel.enumnode.CjNamedEnumConstructorParameter;
import com.huawei.ideacj.language.psi.toplevel.enumnode.CjUnnamedEnumConstructorParameter;
...
import com.huawei.ideacj.language.psi.toplevel.extendnode.CjExtendMemberDeclaration;
import com.huawei.ideacj.language.psi.toplevel.extendnode.CjExtendType;
import com.huawei.ideacj.language.psi.toplevel.functionnode.CjBlock;
import com.huawei.ideacj.language.psi.toplevel.functionnode.CjFunctionDefinition;
import com.huawei.ideacj.language.psi.toplevel.functionnode.CjFunctionModifierList;
import com.huawei.ideacj.language.psi.toplevel.functionnode.CjFunctionParameters;
import com.huawei.ideacj.language.psi.toplevel.functionnode.CjLambdaDefinition;
...
import com.huawei.ideacj.language.psi.toplevel.functionnode.CjNondefaultParameterList;
import com.huawei.ideacj.language.psi.toplevel.functionnode.CjOperatorFunctionDefinition;
import com.huawei.ideacj.language.psi.toplevel.functionnode.CjOverloadedOperators;
import com.huawei.ideacj.language.psi.toplevel.functionnode.blocknode.CjExpressionOrDeclaration;
import com.huawei.ideacj.language.psi.toplevel.functionnode.blocknode.CjExpressionOrDeclarations;
import com.huawei.ideacj.language.psi.toplevel.functionnode.blocknode.CjVarOrFuncDeclaration;
...
import com.huawei.ideacj.language.psi.toplevel.interfacenode.CjInterfaceMemberDeclaration;
import com.huawei.ideacj.language.psi.toplevel.macronode.CjMacroAttrDecl;
import com.huawei.ideacj.language.psi.toplevel.macronode.CjMacroAttrExpr;
import com.huawei.ideacj.language.psi.toplevel.macronode.CjMacroAttrType;
...
import com.huawei.ideacj.language.psi.toplevel.macronode.CjMacroInputExprWithParens;
...
import com.huawei.ideacj.language.psi.toplevel.structnode.CjStructMemberDeclaration;
import com.huawei.ideacj.language.psi.toplevel.structnode.CjStructName;
import com.huawei.ideacj.language.psi.toplevel.structnode.CjStructNamedInitParam;
import com.huawei.ideacj.language.psi.toplevel.structnode.CjStructPrimaryInit;
import com.huawei.ideacj.language.psi.toplevel.structnode.CjStructUnnamedInitParam;
import com.huawei.ideacj.language.psi.toplevel.structnode.CjStructPrimaryInitParamLists;

...
import com.huawei.ideacj.filetypes.CangjieDeclarationFile;
...
/**
 * CangjieDeclarationPsiFileRoot
 *
 * @since 2025/02/17
 */
public class CangjieDeclarationPsiFileRoot extends PsiFileBase {
    /**
    ...
    public CangjieDeclarationPsiFileRoot(@NotNull FileViewProvider viewProvider) {
        super(viewProvider, CangjieDeclarationLanguage.INSTANCE);
    }

    @NotNull
    @Override
    public FileType getFileType() {
        return CangjieDeclarationFile.INSTANCE;
    }

...
package com.huawei.ideacj.language.psi.packagenode;
 ...
 * @since 2021-06-24
 */
public class CjPackageNameIdentifier extends CJPsiNode implements CangjieGetID {
    public CjPackageNameIdentifier(@NotNull ASTNode node) {
        super(node);
    }

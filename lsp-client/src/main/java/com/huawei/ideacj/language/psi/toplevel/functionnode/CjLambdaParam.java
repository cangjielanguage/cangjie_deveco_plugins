 ...
 * @since 2024-05-14
 */
public class CjLambdaParam extends CangjieNamedElement implements CangjieGetID {
    public CjLambdaParam(@NotNull ASTNode node) {
        super(node);
    }

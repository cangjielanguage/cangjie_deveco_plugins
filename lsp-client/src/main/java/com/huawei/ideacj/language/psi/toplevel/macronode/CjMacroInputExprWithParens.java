...
/**
 * CjMacroInputExprWithParens
 *
 * @since 2024-02-06
 */
public class CjMacroInputExprWithParens extends CJPsiNode implements CangjieGetID {
    public CjMacroInputExprWithParens(@NotNull ASTNode node) {
        super(node);
    }
}

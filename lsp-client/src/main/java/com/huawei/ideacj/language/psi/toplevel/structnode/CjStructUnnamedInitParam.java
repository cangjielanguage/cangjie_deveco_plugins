...
/**
 * RecordUnnamedInitParam
 *
 * @since 2022-04-27
 */
public class CjStructUnnamedInitParam extends CangjieNamedElement implements CangjieGetID {
    public CjStructUnnamedInitParam(@NotNull ASTNode node) {
        super(node);
    }
}

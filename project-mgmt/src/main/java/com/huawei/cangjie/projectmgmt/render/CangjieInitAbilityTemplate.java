...
import com.huawei.deveco.projectmgmt.ohos.template.render.init.InitAbilityTemplate;
...
/**
 * CangjieInitAbilityTemplate
 *
 * @since 2024/03/13
 */
public class CangjieInitAbilityTemplate extends InitAbilityTemplate {
    @Override

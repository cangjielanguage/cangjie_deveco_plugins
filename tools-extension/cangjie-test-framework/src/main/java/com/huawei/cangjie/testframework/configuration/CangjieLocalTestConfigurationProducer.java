...
/**
 * CangjieLocalTestConfigurationProducer
 *
 * @since 2025/08/28
 */
public class CangjieLocalTestConfigurationProducer extends CangjieTestConfigurationProducer {
    protected CangjieLocalTestConfigurationProducer() {
        super();
    }
    ...
    protected boolean setupConfigurationFromContext(@NotNull CangjieTestRunConfiguration configuration,
        ...
        if (!isSameOrSubPath(localTestPath, file.getVirtualFile().getCanonicalPath())) {
            return false;
        }
    ...
    public ConfigurationFactory getConfigurationFactory() {
        return CangjieLocalTestRunConfigurationType.getInstance();
    }
}

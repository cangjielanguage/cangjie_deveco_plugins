...
/**
 * CangjieOhosTestRunConfigurationType
 *
 * @since 2025/08/28
 */
public class CangjieOhosTestRunConfigurationType extends SimpleConfigurationType {
    /**
     * necessary, distinguish between Cangjie and ArkTs (name is OpenHarmonyTest) test configuration
     */
    public static final String ID = "CangjieTest";

    private static final String NAME_OR_DESCRIPTION = "Cangjie Instrument Test";

    public CangjieOhosTestRunConfigurationType() {
     ...
     * getInstance
     *
     * @return CangjieOhosTestRunConfigurationType
     */
    public static CangjieOhosTestRunConfigurationType getInstance() {
        return ConfigurationTypeUtil.findConfigurationType(CangjieOhosTestRunConfigurationType.class);
    }
